      ...
      <div className={`min-h-screen ${isDarkMode ? 'bg-neutral-dark' : 'bg-neutral'}`}>
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto text-center py-16">
            <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-4 ${isDarkMode ? 'text-primary-dark' : 'text-primary'}`}>404</h1>
            <h2 className={`text-2xl md:text-3xl font-semibold mb-6 ${isDarkMode ? 'text-primary-dark' : 'text-primary'}`}>Article Not Found</h2>
            <p className={`mb-8 ${isDarkMode ? 'text-secondary-dark' : 'text-secondary'}`}>
        ...
        <article>
          <div className="relative w-full h-[60vh] md:h-[75vh] lg:h-[90vh] overflow-hidden">
            <Image
              ...
              priority
            />
            <div className={`absolute bottom-0 left-0 right-0 w-[90vw] md:w-[85vw] lg:w-[75vw] mx-auto ${
              isDarkMode ? 'bg-neutral-dark' : 'bg-neutral'
            }`}>
              <div className="mx-auto text-center px-4 md:px-8 lg:px-80">
                <h1 className={`text-3xl md:text-4xl lg:text-6xl font-bold mt-8 md:mt-12 lg:mt-16 mb-4 md:mb-6 lg:mb-8 ${
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4 mb-4">
                  ...
                  <div className="flex gap-2">
                    <button className={`h-6 w-6 md:h-7 md:w-7 lg:h-8 lg:w-8 flex items-center justify-center ${
                      isDarkMode 
                        ? 'bg-primary-dark text-neutral-dark hover:bg-primary-dark/90' 
                        : 'bg-primary text-neutral hover:bg-primary/90'
                    }`}>
          ...
          <div className="w-[90vw] md:w-[85vw] lg:w-[75vw] mx-auto px-4 md:px-8 lg:px-80">
            <div>
              <hr className={`border-t my-6 md:my-8 ${
                isDarkMode ? 'border-secondary-dark' : 'border-secondary'
              }`} />
              <p className={`mb-6 md:mb-8 lg:mb-10 text-2xl md:text-3xl lg:text-4xl italic text-center ${
                isDarkMode ? 'text-primary-dark' : 'text-primary'
              }`}>{article.excerpt}</p>
              <div className={`${styles.prose} ${isDarkMode ? styles.dark : ''}`}>
