      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto text-center py-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-pink-500 mb-4">404</h1>
            <h2 className="text-2xl md:text-3xl font-semibold mb-6">Article Not Found</h2>
            <p className="text-gray-600 mb-8">
              The article you are looking for might have been removed or is temporarily unavailable.
            </p>
            <Link href="/" className="inline-block bg-pink-500 text-white px-4 md:px-6 py-2 md:py-3 rounded-full hover:bg-pink-600 transition-colors">
              Return to Homepage
            </Link>
          </div>
        </main>
        ...
        <article>
          <div className="relative w-full h-[60vh] md:h-[75vh] lg:h-[90vh] overflow-hidden">
            <Image
              ...
              priority
            />
            <div className="absolute bottom-0 left-0 right-0 bg-neutral w-[90vw] md:w-[85vw] lg:w-[75vw] mx-auto">
              <div className="mx-auto text-center px-4 md:px-8 lg:px-80">
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mt-8 md:mt-12 lg:mt-16 mb-4 md:mb-6 lg:mb-8 text-primary">{article.title}</h1>
                <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4 mb-4 text-primary">
                  <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <span className="text-lg md:text-xl text-secondary">•</span>
                    <span className="text-sm md:text-base text-secondary">{article.date}</span>
                  </div>
                  <div className="flex gap-2">
                    <button className="bg-primary text-white h-6 w-6 md:h-7 md:w-7 lg:h-8 lg:w-8 flex items-center justify-center">
          ...
          <div className="w-[90vw] md:w-[85vw] lg:w-[75vw] mx-auto px-4 md:px-8 lg:px-80">
            <div>
              ...
              <p className="mb-6 md:mb-8 lg:mb-10 text-primary text-2xl md:text-3xl lg:text-4xl italic text-center">{article.excerpt}</p>
