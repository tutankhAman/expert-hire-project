      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <Link href="/" className="inline-block bg-pink-500 text-white px-6 py-3 rounded-full hover:bg-pink-600 transition-colors">
              Return to Homepage
            </Link>
          </div>
        </main>
              ...
              <div className="mx-auto text-center px-80">
                ...
                <div className="flex justify-between items-center mb-4 text-primary">
                  ...
                  <div className="flex gap-2">
                    <button className="bg-primary text-white h-8 w-8 flex items-center justify-center">
