    ...
    <div className="space-y-16 mt-16">
      ...
      <div className="bg-neutral shadow-md px-6 border-2 relative border-black">
        <div className="text-center mb-6">
          <div className="relative w-36 h-36 mx-auto mt-[-72]">
            <Image
          ...
          <h3 className="text-4xl font-bold mb-2 mt-4">Aman Aziz</h3>
          <p className="text-base/8 text-gray-700 leading-relaxed mb-6">
          ...
          <p className="text-lg font-bold text-gray-700 leading-relaxed mb-14">
            Follow Me
          </p>
        </div>
        <div className="flex justify-center space-x-2 -mb-16">
          <a href="#" className="bg-primary h-16 w-16 flex items-center justify-center transform -translate-y-1/2 hover:bg-primary/90 transition-colors">
