...
export default function Sidebar() {
  return (
    <div className="space-y-8 md:space-y-16 mt-8 md:mt-16">
      {/* Author Profile */}
      <div className="bg-neutral shadow-md px-4 md:px-6 border-2 relative border-black">
        <div className="text-center mb-4 md:mb-6">
          ...
          <h3 className="text-2xl md:text-4xl font-bold mb-2 mt-4">Aman Aziz</h3>
          ...
          <p className="text-base md:text-lg font-bold text-gray-700 leading-relaxed mb-8 md:mb-14">
            Follow Me
          </p>
        </div>
        <div className="flex justify-center space-x-2 -mb-12 md:-mb-16">
          <a href="#" className="bg-primary h-12 w-12 md:h-16 md:w-16 flex items-center justify-center transform -translate-y-1/2 hover:bg-primary/90 transition-colors">
